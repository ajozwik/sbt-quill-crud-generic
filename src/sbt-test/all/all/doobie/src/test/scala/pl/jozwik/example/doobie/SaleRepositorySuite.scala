...
import pl.jozwik.example.doobie.repository.{ PersonRepositoryGen, ProductRepositoryGen, SaleRepositoryGen }
trait SaleRepositorySuite extends AbstractDoobieSpec {
